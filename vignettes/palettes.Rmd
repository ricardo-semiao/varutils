...
Many `varutils` give the change for the user to change the colors of the graph trough the argument `palette`. This argument can have multiple specifications. It can be:
