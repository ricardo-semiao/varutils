...
Some `varutils` functions give the chance for the user to change the colors of the graph trough the argument `colors`. This argument can have multiple specifications:
