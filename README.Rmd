...
[![CRAN status](https://www.r-pkg.org/badges/version/varutils)](https://CRAN.R-project.org/package=varutils)
...
* Start using rlang and glue APIs wherever possible.
  * Specially in the "setup" suite, as in the [vardiff](https://ricardo-semiao.github.io/vardiff/) package.
* More thorough tests:
...
* Rethink some naming conventions:
  * Change "args_..." to "..._args" in arguments names
...
* Uses [testthat](https://testthat.r-lib.org/) and [vdiffr](https://vdiffr.r-lib.org/) for automate tests.
